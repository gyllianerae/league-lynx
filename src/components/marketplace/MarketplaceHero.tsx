...
export const MarketplaceHero = () => {
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-mint/20 to-mint/5 border border-mint/10 backdrop-blur-xl p-8">
      <div 
      ...
      <div className="relative">
        <div className="flex items-center gap-2 bg-mint/10 w-fit px-4 py-2 rounded-full border border-mint/20 mb-6">
          ...
          <span className="text-mint text-sm font-medium">League Marketplace</span>
        </div>
